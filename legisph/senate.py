...
# %% auto 0
__all__ = ['Senator', 'SenateCommittee', 'SenateBill', 'SenateWebsite', 'PendingInCommittee', 'ConductedJointProceedings',
           'IntroducedBySenator']
...
# %% ../notebooks/02-senate.ipynb 36
class ConductedJointProceedings(SenateBill.SenateBillStatus):
...
# %% ../notebooks/02-senate.ipynb 38
class IntroducedBySenator(SenateBill.SenateBillStatus):
